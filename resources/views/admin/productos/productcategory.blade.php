                            ...
                            <tbody>
                                @foreach ($productoListas as $productoLista)
                                    <tr @if ($productoLista->status == 0) class="table-danger" @endif>
                                        ...
                                        <td>{{ ucfirst($productoLista->categoriaProduct->nombre) }}</td>
                                        <td>{{ ucfirst($productoLista->nombre) }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.productos.show', $productoLista->id) }}">
                                                        <i class="far fa-bookmark"></i> 
                                                        Ver producto
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.productos.edit', $productoLista->id) }}">
                                                   ...
                                                   @can('delete producto')
                                                    <form action="{{ route('admin.productos.delete', $productoLista->id) }}"
                                                        ...
                                                        <button class="dropdown-item"
                                                            href="{{ route('admin.productos.delete', $productoLista->id) }}">
