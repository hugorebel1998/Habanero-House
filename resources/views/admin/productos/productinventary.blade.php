                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <input type="number" name="cantidad" min="1"
                                                class="form-control @error('cantidad') is-invalid @enderror" value="1">
                                            @error('cantidad')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="dropdown dropleft">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.productos.inventario.indexDelete') }}">
                                                    ...
                                                    @can('update producto')
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                @can('delete producto')
                                                                    <form
                                                                        action="{{ route('admin.productos.inventario.delete', $inventario->id) }}"
