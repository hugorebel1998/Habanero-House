            ...
            <form action="{{ route('admin.ajustes.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card  collapsed-card">
                            <div class="card-header bg-rojo text-white">
                                <h3 class="card-title"><i class="fas fa-cogs"></i> General</h3>
                    ...
                    <div class="col-md-6">
                        <div class="card  collapsed-card">
                            <div class="card-header bg-rojo text-white">
                                <h3 class="card-title"><i class="fas fa-dollar-sign"></i> Moneda y precio</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                        data-toggle="tooltip" title="Collapse">
                                        <i class="fas fa-plus text-white"></i></button>
                    ...
                    <div class="col-md-6">
                        <div class="card collapsed-card">
                            <div class="card-header bg-rojo text-white">
                                <h3 class="card-title"><i class="fas fa-wifi"></i> Redes sociales</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                        data-toggle="tooltip" title="Collapse">
                                        <i class="fas fa-plus text-white"></i></button>
                    ...
                    <div class="col-md-6">
                        <div class="card collapsed-card">
                            <div class="card-header bg-rojo text-white">
                                <h3 class="card-title"><i class="fas fa-cash-register"></i> Método depago</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                        data-toggle="tooltip" title="Collapse">
                                        <i class="fas fa-plus text-white"></i></button>
