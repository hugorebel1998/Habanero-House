                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" name="nombre"
                                            ...
                                            value="{{ $usuario->name }}"> @error('nombre')
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <input type="text" name="apellido_paterno"
                                            ...
                                            value="{{ $usuario->apellido_paterno }}"> @error('apellido_paterno')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <input type="text" name="apellido_materno"
                                            ...
                                            value="{{ $usuario->apellido_materno }}"> @error('apellido_materno')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="date" name="fecha_de_nacimiento"
                                            ...
                                            value="{{ $usuario->fecha_nacimiento }}"> @error('fecha_de_nacimiento')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="number" name="teléfono"
                                            ...
                                            value="{{ $usuario->telefono }}"> @error('teléfono')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mt-4">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <input type="email" name="correo_electrónico"
                                            ...
                                            value="{{ $usuario->email }}">
                                        <span class="form-text text-muted">Puedes utilizar letras, números y
                                            puntos</span> @error('correo_electrónico')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                <div class="text-center mt-4">
                                    <button type="submit" class="btn btn-sm btn-danger mb-3"> <i
                                            class="fas fa-save"></i>
                                        Actualizar</button>
                                </div>
                            </form>
