                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped shadow">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>
                                        <form action="{{ route('usuario.cart.delete', $item->id) }}" method="POST"
                                            class="eliminar_orden">
                                            @csrf
                                            @method('Delete')
                                    ...
                                    <td>
                                        <a href="{{ route('usuario.mostrar.show',  $item->getProduct->id)}}" class="text-dark">{{
                                            $item->label_item}}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="{{ route('usuario.cart.update', $item->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <input type="number" name="cantidad" class="form-control" id="cantidad_cart"
                                                value="{{ $item->cantidad }}">
